...
with st.expander("Create New Attendence Sheet"):
    ...
    if st.button("Create New Attendence Sheet"):
        ...
        df.to_csv("./Attendence/With_Camera/" +
...
df = pd.read_csv("./Attendence/With_Camera/" +
...
while start:
    ...
    if face_names:
        for face_loc, name in zip(face_locations, face_names):
            ...
            with open("./Attendence/With_Camera/" + name_of_attendence_sheet+".csv", 'a') as csv_file:
